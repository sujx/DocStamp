<template>
  <div class="pt-3">
    ...
    <p class="text-sm mb-5 text-pretty" :style="{ color: 'var(--color-text-secondary)' }">{{ $t("watermark.description") }}</p>
    ...
    <div v-if="selectedFile" class="p-4 mt-4 rounded-lg" :style="{ backgroundColor: 'var(--color-surface)' }">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <UFormGroup :label="$t('watermark.opacity')">
          ...
          <span class="text-xs text-pretty" :style="{ color: 'var(--color-text-tertiary)' }">{{ params.opacity }}</span>
        </UFormGroup>
        ...
        <UFormGroup :label="$t('watermark.rotation')">
          ...
          <span class="text-xs text-pretty" :style="{ color: 'var(--color-text-tertiary)' }">{{ params.rotation }}&deg;</span>
        </UFormGroup>
      ...
      <!-- Preview canvas -->
      <div class="mb-4">
        <p class="text-xs mb-2" :style="{ color: 'var(--color-text-tertiary)' }">{{ $t("watermark.preview") }}</p>
