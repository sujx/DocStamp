import { hasInjectionContext, getCurrentInstance, inject, ref, watchEffect, watch, unref, version, createApp, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, toRef, defineAsyncComponent, mergeProps, getCurrentScope, computed, defineComponent, h, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-50f04a34"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DYwIGzv8.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-1dFGBXKB.mjs'));
